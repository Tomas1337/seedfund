...
export default function ImageUploader({ defaultImage, updateUrl_image2 }) {
  ...
  function uploadFile(file) {
    ...
    xhr.onreadystatechange = (e) => {
      if (xhr.readyState == 4 && xhr.status == 200) {
        ...
        updateUrl_image2(response.secure_url);
      }
    };
          ...
          <form className="flex justify-center items-center h-full">
            {progress === 0 ? (
              <div className="text-gray-700 text-center">
                <button
                  className="bg-blue-600 hover:bg-blue-800 text-black font-bold px-4 py-2 rounded block m-auto"
